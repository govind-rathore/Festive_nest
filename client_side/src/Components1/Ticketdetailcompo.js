...
function Ticketdetailcompo() {
  ...
  function convertTo12HourFormat(time) {
    ...
    const twelveHourFormat = ((hours + 11) % 12 + 1).toString().padStart(2, '0') + ':' + minutes.toString().padStart(2, '0');
    return twelveHourFormat + ' ' + period;
  }
  ...
  <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">
    {convertTo12HourFormat(product.Start_Time)} onwards.
  </p>
</div>
  ...
  <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">
    {new Date(product.Event_Date).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
  </p>
</div>
            ...
            >
              ...
              >
                ...
                >
                  Organizer Contact
                  <br />
                  <a href="tel:+9198765XXXXX">{product.Qrganizer_contact_number}</a>
                </h4>
              </div>
