  ...
  return (
    <div>
      <div className="grid mt-0 mr-auto mb-0 ml-auto grid-cols-1 lg:max-w-screen-xl gap-0 lg:grid-cols-12">
        <div className="w-full mt-6 mr-auto mb-0 ml-auto pt-4 pr-4 pb-4 pl-4 col-span-1 lg:col-span-4 xl:p-12 sm:w-2/4 lg:w-full">
          ...
          <div className="pt-0 pr-0 pb-1 pl-0 space-y-4">
            <div className="block">
              ...
              <input value={email} onChange={handleChangeEmail} type="email" placeholder="Ex. joshi@bond.com" className="w-full rounded-md border-2 hover:border-purple-700 pt-2 pr-3 pb-2 pl-3"/>
            </div>
            <div className="block">
              <p className="text-gray-700 font-medium text-xs mt-4 mr-0 mb-1 ml-0 block">Your Password</p>
              <input value={password} onChange={handleChangePassword} type="password" placeholder="••••••••" className="w-full rounded-md border-2 hover:border-purple-700 pt-2 pr-3 pb-2 pl-3"/>
            </div>
          ...
          <div className="mt-6 mr-0 mb-6 ml-0 space-y-2">
            ...
            <a className="text-xs inline text-purple-700 hover:text-black" href="register">Create an account</a>
