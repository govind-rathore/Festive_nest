import styles from "./CanvaClone.module.css"; // Import the module CSS file
...
function CanvaClone({
  ...
  return (
      <div className={styles.caseContainer}> {/* Use the module CSS class name */}
        <div className={styles.wrapper}> {/* Use the module CSS class name */}
          <div ref={cesdkContainer} className={styles.cesdk}></div> {/* Use the module CSS class name */}
        </div>
      </div>
  );
};
